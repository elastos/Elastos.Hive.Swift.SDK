...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ElastosDIDSDK/ElastosDIDSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ElastosHiveSDK/ElastosHiveSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReadWriteLock/ReadWriteLock.framework"
